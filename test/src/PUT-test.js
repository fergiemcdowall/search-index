...
test('can add data', t => {
  ...
  t.plan(9)
  global[indexName]._PUT(data).then(response => response.map(item => {
...
test('Verify that _PUT has created an appropriate index (_PUT_1 again)', t => {
  const indexEntries = [
    ...
    {
      key: '￮DOC_RAW￮undefinedXXXX￮',   // <- TODO: this is wrong!!!!!
...
test('can add data', t => {
  t.plan(1)
  global[indexName2]._PUT(carData, {
...
test('Verify that _PUT has created an appropriate index (_PUT_2)', t => {
  const indexEntries = [
    {"key":"brand:volvo#1.00","value":["0","1","2"]},
    {"key":"manufacturer:tesla#1.00","value":["2"]},
    {"key":"manufacturer:volvo#1.00","value":["0","1"]},
...
test('Verify that _PUT has created an appropriate index (_PUT_3)', t => {
  const indexEntries = [
...
test('Verify that _PUT has created an appropriate index (_PUT_4)', t => {
  const indexEntries = [
    {"key":"info.brand:volvo#1.00","value":["0","1","2"]},
    {"key":"make:bmw#1.00","value":["1"]},
    {"key":"make:tesla#1.00","value":["0","2"]},
...
test('Verify that _PUT has created an appropriate index (doesnt index children of DO_NOT_INDEX_FIELD)', t => {
  const indexEntries = [
    {"key":"info.brand:volvo#1.00","value":["0","1","2"]},
    {"key":"make:bmw#1.00","value":["1"]},
    {"key":"make:tesla#1.00","value":["0","2"]},
