...
test('can add data', t => {
  const data = [
    {
      "_id": 0,
      text: sanitise("The Beatles were an English rock band formed in Liverpool in 1960. With a line-up comprising John Lennon, Paul McCartney, George Harrison and Ringo Starr, they are regarded as the most influential band of all time.")
    },
    {
      "_id": 1,
      text: sanitise("We saw the suits in a window and just went in and got them. We all got one, and suddenly that was a uniform. We were going to all these shops and buying little uniforms for ourselves. That’s also why we looked like Beatles; beside the haircut, we were all looking the same")
    },
    {
      "_id": 2,
      text: sanitise("Over 50 years after the The Beatles’ ‘White Album’ first stormed the charts, the Fab Four’s iconic double-album achieved 24-time Platinum-certified status – making it the fourth-highest certified release in US history.")
    },
    {
      "_id": 3,
    ...
    {
      "_id": 4,
      text: sanitise("Paul McCartney will make his eagerly anticipated return to the road with his new 'Freshen Up' tour.")
    },
    {
      "_id": 5,
      text: sanitise("John Lennon's most celebrated solo album will be honoured with a number of special releases on October 5 including the six-disc Imagine – The Ultimate Collection.")
    },
    {
      "_id": 6,
    ...
    {
      "_id": 7,
      text: sanitise("The Beatles’ legendary animated hit film YELLOW SUBMARINE is returning to cinemas across the UK, Ireland and the U.S. this summer.")
    },
    {
      "_id": 8,
    ...
    {
      "_id": 9,
      text: sanitise("Paul invites you on a musical journey to Egypt Station, estimated time of arrival Friday 7th September 7, 2018 by way of Capitol Records.")
    }
  ]
