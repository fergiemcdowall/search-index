...
test('can verify store', t => {
  const entries = [
    { key: 'text:a#1.00', value: ['1', '2', '3'] },
    { key: 'text:banana#1.00', value: ['1'] },
    { key: 'text:giant#1.00', value: ['1', '2'] },
    { key: 'text:pineapple#1.00', value: ['2', '3'] },
    { key: 'text:small#1.00', value: ['3'] },
    ...
    {
      key: '￮DOC￮1￮',
      value: { _id: '1', text: ['a#1.00', 'banana#1.00', 'giant#1.00'] }
    },
    {
      key: '￮DOC￮2￮',
      value: { _id: '2', text: ['a#1.00', 'giant#1.00', 'pineapple#1.00'] }
    },
    {
      key: '￮DOC￮3￮',
      value: { _id: '3', text: ['a#1.00', 'pineapple#1.00', 'small#1.00'] }
    },
