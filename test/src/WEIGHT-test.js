...
test('create a search index with synonyms (can be in all fields)', async function (t) {
  ...
  const { PUT, DICTIONARY, QUERY, SEARCH } = await si({
    name: sandbox + 'WEIGHT',
  })
  t.ok(PUT)
  ...
  // }), {
  //   RESULT: [
  //     { _id: '1', _match: [ 'make:bmw#2.00' ], _score: 2 },
  //     { _id: '7', _match: [ 'make:bmw#2.00' ], _score: 2 },
  //     { _id: '9', _match: [ 'make:bmw#2.00' ], _score: 2 },
  //     { _id: '3', _match: [ 'brand:bmw#1.00' ], _score: 1 },
  //     { _id: '6', _match: [ 'brand:bmw#1.00' ], _score: 1 },
  //     { _id: '8', _match: [ 'manufacturer:bmw#1.00' ], _score: 1 }
  //   ],
  //   RESULT_LENGTH: 6
  // })
