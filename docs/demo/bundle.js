(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('fergies-inverted-index'), require('term-vector')) :
  typeof define === 'function' && define.amd ? define(['fergies-inverted-index', 'term-vector'], factory) :
  (global = global || self, global.searchIndex = factory(global.fii, global.tv));
}(this, (function (fii, tv) { 'use strict';

  fii = fii && fii.hasOwnProperty('default') ? fii['default'] : fii;
  tv = tv && tv.hasOwnProperty('default') ? tv['default'] : tv;
  ...
  var main = ops => initIndex(ops).then(makeASearchIndex);
