...
module.exports = function (options) {
  ...
  var indexDoc = function (reverseIndex, doc, batchOptions, callback) {
    ...
    _.forEach(searchableFields, function (searchableField) {
      ...
      fieldOptions.fieldName = searchableField;
      fieldOptions = _.defaults(_.find(batchOptions.fieldOptions, 'fieldName', searchableField) || {}, batchOptions.defaultFieldOptions);
      if (!fieldOptions.fieldedSearch && fieldOptions.fieldName != '*') return;
      var docVector = [];
