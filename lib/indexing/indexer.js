...
exports.addDocToIndex = function(indexes, indexesMultiply, batchString, batchName, filters, callback) {
  var i,
      batch,
      docIDs,
      indexDocs;
    ...
    indexDocs = function (i) {
      if (i < docIDs.length) {
        ...
        calibrater.incrementallyCalibrate(indexesMultiply, reduceTF(tf), function(msg) {
          console.log(msg);
          console.log('[success] indexed batch: ' + batchName + '\n');
