...
module.exports = function (options) {
  ...
  var indexer = require('./indexing/indexer.js')({
    ...
    fieldedSearchOnAllFieldsByDefault: SearchIndex.options.fieldedSearchOnAllFieldsByDefault
  });
  ...
  SearchIndex.add = function (batchOptions, batch, callback) {
    var defaults = {
      ...
      filters: {},
      nGramLength: 1,
      canDoFieldedSearchOn: ['*']
    };
    batchOptions = _.defaults(batchOptions || {}, defaults);
    if (batchOptions.canDoFieldedSearchOn.indexOf('*') == -1)
      batchOptions.canDoFieldedSearchOn.push('*');
