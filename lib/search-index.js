...
var SearchIndex = module.exports = function SearchIndex (options) {
  ...
  indexer.setIndexOptions(options);
  deleter.setIndexOptions(options);
  calibrater.setIndexOptions(options);
  searcher.setIndexOptions(options);
  indexPeek.setIndexOptions(options);
  matcher.setIndexOptions(options);
  replicator.setIndexOptions(options);
